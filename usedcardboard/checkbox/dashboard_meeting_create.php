                            ...
                            <div class="tab-content" id="">
                                ...
                                <div class="card shadow mb-4 add_icon_parent_m">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 matrix_main_inner_content">
                                                   ...
                                                   <?php  }
                                                        ...
                                                        $scorecard_data_sql = "SELECT scorecard.id,scorecard.name,scorecard.goal,scorecard.goal_matric FROM scorecard where (scorecard.attach_meeting like '%-".$meeting_id."-%' OR scorecard.attach_meeting like '%-".$meeting_id."' OR scorecard.attach_meeting like '".$meeting_id."-%' OR scorecard.attach_meeting = ".$meeting_id.") AND (scorecard.archived = false) ORDER BY scorecard.meeting_create_order_no ASC";
                                                        ...
                                                        while($scorecard_data = array_shift($scorecard_data_query)){
                                                            ...
                                                            <tr data-sort-id="<?=new_dash_encrypt($scorecard_data['id'])?>">
                                                                ...
                                                                <a type="button" class="" data-toggle="modal"
                                                                    ...
                                                                    data-whatever="<?=new_dash_encrypt($scorecard_data['id'])?>" data-todo='{"EditingFrom":"EditMeetingMatrix"}'><?= $scorecard_data['name'] ?>
                                                                </a>
                                                                </td>
                                                                <td class="matrix_goal">
                                                                    <a type="button" class="" data-toggle="modal"
                                                                    data-target="#scorecardAddMatrixModalPopop"
                                                                    data-whatever="<?=new_dash_encrypt($scorecard_data['id'])?>" data-todo='{"EditingFrom":"EditMeetingMatrix"}'><?=$goal?>
                                                                </a>
                                                                </td>
                                                                <td class="td_w_15 matrix_goal_matrix">
                                                                    <a type="button" class="" data-toggle="modal"
                                                                        data-target="#scorecardAddMatrixModalPopop"
                                                                        data-whatever="<?=new_dash_encrypt($scorecard_data['id'])?>" data-todo='{"EditingFrom":"EditMeetingMatrix"}'><?=$scorecard_data['goal_matric']?>
                                                                    </a>
                                                                </td>
                                                                <td>
                                        ...
                                        <!-- <div class="add_icon_m" add_type="measurable" data-tooltip="true" data-placement="left" title="Add Measurable" data-toggle="modal" data-target="#addMeasurablesModalMeetCreate">
                                            ...
                                            <a type="button" add_type="measurable" class="add_icon_m text-white" data-toggle="modal" data-tooltip="true" data-placement="left" title="Add Measurable"
                                                data-target="#scorecardAddMatrixModalPopop"
                                                data-whatever="new_measurement"
                                                data-todo='{"EditingFrom":"EditMeetingAddMatrixModal"}'>
                                                <i class="fa fa-plus"></i>
                                            </a>
...
<script>
    $(document).ready(function() {  
        ...
        // Format options
            ...
            $('#add_to_seat').select2({width:'100%'});
            $('.whos_accountable').select2({width:'100%'});
            $('.accountable_owner').select2({width:'100%'});
            $('.marix_add_to_meetings').select2({width:'100%'});
            $('.attendee_meeting').select2({width:'100%'});
            ...
            $('#save-meeting-name').click(function(){
                ...
                var hidden_meeting_id=$('#hidden_meeting_id').val();
                    ...
                    if(flag==true){
                        var all_data={meeting_name,hidden_meeting_id, 'meeting_action':'save-meeting-name'}
                        $.ajax({
        ...
        $('#addAttendeeCreateMeeting').click(function(){
            ...
            $.ajax({
                url:'dashboard_meeting_action.php',
                type:'post',
                data:{'meeting_attendees_list':1,meeting_id},
                datatype:'json',
                async:false,
                beforeSend: function () {
        ...
        $('#add_existing_attendees').submit(function(){
            ...
            $.ajax({
                url:'dashboard_meeting_action.php',
                type:'post',
                data:{'add_meeting_attendees':1, attendees,meeting_id},
                datatype:'json',
                async:false,
                beforeSend: function () {
        ...
        $(document).on('click','.meeting_attendees_delete',function(){
            ...
            $.ajax({
                url:'dashboard_meeting_action.php',
                type:'post',
                data:{'delete_meeting_attendees':1, meeting_attendee_id,meeting_id},
                datatype:'json',
                async:false,
                success:function(response){
                    displayAttendeeDataAfterMeetingAction(JSON.parse(response));
        ...
        $('#add_existing_project').submit(function(){
            ...
            $.ajax({
                url:'project_action.php',
                type:'post',
                data:{'add_existing_project_meeting':1, project_id,meeting_id},
                datatype:'json',
                async:false,
                beforeSend: function () {
        ...
        function check_meeting_saved(action=""){
            ...
            if(meeting_id==""){
                ...
                setTimeout(function() { $('#blank_meeting_msg').fadeOut(3000); }, 3000);
                return false;
                ...
                $.ajax({
                    type : 'GET',
                    url:'dashboard_meeting_action.php',
                    data: {archive_meeting:1,meeting_id},
                    async:false,
                    success:function(response){
                    }
                })
        ...
        function deleteMatrix(currentRow, delMatrixID){
            if(delMatrixID){
                $.ajax({
                    ...
                    url:'dashboard_meeting_action.php',
                    cache : true,
                    data : {'das_meeting_matrics' : 'deleteMatrix','matrixID' : delMatrixID, 'meetingID' : '<?=isset($meeting_id) && $meeting_id != '' ? $meeting_id : 0 ?>'},
                    success : function(response){
