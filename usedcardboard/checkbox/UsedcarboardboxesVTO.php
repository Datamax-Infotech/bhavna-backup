<?php session_start();
    ...
    $vto_data_sql=db_query("SELECT id,title,description FROM usedcarboardboxes_vto",db_project_mgmt());
    $vto_name_array=[];
	...
	<script>
        ...
        function open_popup(id){
            $.ajax({
                ...
                type:'get',
                data:{'edit_vto':'usedcarboardboxes_vto',id},
                datatype:'json',
        ...
        $("#company_vto_form_fields").submit(function(){
            ...
            $.ajax({
                url:'dashboard_meeting_action.php',
                type:'post',
                data:{'update_vto':'usedcarboardboxes_vto',title,description,id},
                datatype:'json',
                async:false,
                beforeSend: function () {
