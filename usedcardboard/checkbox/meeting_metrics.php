...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            <div>
                ...
                if ($meeting_id != "" && $meeting_timer_id != "") {
                    $sidebar_links = "";
                    $top_links = "common_top_links";
                    require("meeting_start_common_links.php");
                    ?>
                    <div class="container-fluid  mt-0">
                        <div class="row justify-content-center mt-4">
                            <?php $top_links = "";
                            $sidebar_links = "common_sidebar_links";
                            require("meeting_start_common_links.php"); ?>
                            <div class="col-md-10">
                                <div class="card shadow mb-4">
                                    ...
                                    if ($count == 0) { ?>
                                        <div
                                            class="card-body min_height_500 d-flex justify-content-center align-items-center text-center">
                                            <div>
                                    ...
                                    <?php } else {
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                <table id="meetingMetricsTable"
                                                    class="table table-sm text-center meetingMetricsTable" width="100%"
                                                    cellspacing="0">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($scorecard_data = array_shift($scorecard_data_query)) {
                                                            ...
                                                            <tr data-sort-id="<?= new_dash_encrypt($scorecard_weeks_id) ?>">
                                                                ...
                                                                <td class="matrics_attandees_img"><span class="attendees_img"
                                                                        style="background-image:url('<?= $scorecardUserImage ?>')">
                                                                        <?= $scorecardUserText ?>
                                                                    </span></td>
                                                                <td class="td-border-bottom matrics_mesurable_name text-left">
                                                                    <a id="measurableModal" type="button" class=""
                                                                        data-toggle="modal"
                                                                        data-target="#scorecardAddMatrixModalPopop"
                                                                        data-whatever="<?= new_dash_encrypt($scorecard_weeks_id) ?>"
                                                                        data-todo='{"EditingFrom":"meetingStartMatrix"}'>
                                                                        <?= $scorecard_data['name'] ?>
                                                                    </a>
                                                                </td>
                                                                    ...
                                                                    foreach ($scorecardweeks_for_thead as $week) {
                                                                        ...
                                                                        if (!empty($inner_scorecard_data_query)) {
                                                                            while ($inner_scorecard_data = array_shift($inner_scorecard_data_query)) {
                                                                                ...
                                                                                ?>
                                                                                <td
                                                                                    class="measurable_val_td <?= $putValue == true ? $box_color : '' ?>">
                                                                                    <input type="text" class="edit_content text-center"
                                                                                        onblur="<?= $onblur ?>" onkeyup="matrixvalidateInput(this)"
                                                                                        value="<?= $putValue == true ? $inputValue : '' ?>" />
                                                                                    <input type="hidden" class="tdweek"
                                                                                        value="<?= str_replace('<br>', " to ", $week); ?>">
                                                                                </td>
                                                                            <?
                                                                            }
                                                                        } else {
                                                                ...
                                                                ?>
                                                                <input type="hidden" class="trID"
                                                                    value="<?= new_dash_encrypt($scorecard_data['id']) ?>">
                                                            </tr>
                                                        <?
                                                        }
                                                        ?>
                ...
                <?php } else { ?>
                    <div class="col-md-12 alert alert-danger">
                        <p class="mb-0"><a href="dashboard_meetings.php"><b>Click</b></a> here to choose the Meeting First!
                        </p>
                    </div>
                <?php } ?>
                <?php
        ...
        <style>
            #meetingMetricsTable th,
            #meetingMetricsTable td {
                white-space: nowrap;
            }
