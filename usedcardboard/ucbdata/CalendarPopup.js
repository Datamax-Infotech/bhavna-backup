...
function PopupWindow_showPopup(anchorname) {
	...
	if (this.divName != null) {
		// Show the DIV object
		if (this.use_gebi) {
			document.getElementById(this.divName).style.left = this.x + 50 + "px";
	...
	function PopupWindow_hidePopup() {
		if (this.divName != null) {
			if (this.use_gebi) {
				...
				var element = document.all[this.divName];
				if (element) {
					element.style.visibility = "hidden";
				}
			} else if (this.use_layers) {
				var element = document.layers[this.divName];
				if (element) {
