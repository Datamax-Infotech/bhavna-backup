<?
/*
File Name: UCBZeroWaste_Vendors_AR.php
...
27-03-23      Ashiq     This file is created for the testing purpose. Once the file runs 
							...
							file named UCBZeroWaste_Vendors_AR.php. 
...
<script>	
	function displarepsorteddata(comp_id, vendor_id, dmadepayment, dtfrom, dtto, receives, payables, columnno, sortflg){
		...
		xmlhttp.open("GET","UCBZeroWaste_Vendors_AR_child.php?comp_sel=" + comp_id + "&vendors_dd=" + vendor_id + "&ddMadePayment=" + dmadepayment + "&date_from=" + dtfrom + "&date_to=" + dtto + "&receivables=" + receives + "&payables="+ payables + "&columnno=" + columnno + "&sortflg=" + sortflg ,true);	
		xmlhttp.send();
	}
...
<div class="main_data_css">
	...
	<form method="GET" name="frmwater_report_internal" action="UCBZeroWaste_Vendors_AR.php">
				...
				<? if($isRec == 'y') { ?>
					<tr>
						...
						<td class="display_table" align="center">
							...
							<input type="button" name="btnUpdateVendrRpt" id="btnUpdateVendrRpt" class="btnUpdateVendrRpt" value="Update Vendor Report">
							<input type="button" name="btnUpdateVendrRpt" id="btnUpdateVendrRpt_<?= $arcount-1; ?>" class="btnUpdateVendrRpt" onclick="update_vendor_report(<?= $arcount-1;?>)" value="Update Vendor Report">
						</td>-->
					</tr>
				<? } ?>
			<?
