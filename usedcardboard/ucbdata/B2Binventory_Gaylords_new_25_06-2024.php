						...
						if (!$.isArray(result) || result.length == 0) {
							...
							if (view_type == "grid_view") {
								...
								$.each(result, function(index, res) {
									...
									result_str += `<p><span>ID = ${res["b2b_id"]}</span><span class="text-muted float-right"> Lead Time = <span style="${res["td_leadtime_bg_color"]}"> ${res["box_lead_time"]} </span></span></p>`;
									...
									result_str += '</span>';
									result_str += '<a target="_blank" href="https://b2b.usedcardboardboxes.com/?id=' + res['loop_id_encrypt_str'] + '&checkout=1" class="btn btn-cart-grid">VIEW ITEM</a>';
									result_str += '</div>';
									result_str += '</div>';
									result_str += '</div>';
								});
								...
								if (show_urgent_box == 1) {
									...
									result_str_urgent += '<div class="dashboard_heading" style="font-size: 16px;font-family: Titillium Web, sans-serif;font-weight:600;">For a limited time, these we need to urgently sell!</div>';
									...
									$.each(result, function(index, res) {
										...
										result_str_urgent += '<a target="_blank" href="https://b2b.usedcardboardboxes.com/?id=' + res['loop_id_encrypt_str'] + '&checkout=1" class="btn btn-cart-grid">VIEW ITEM</a>';
										result_str_urgent += '</div>';
										result_str_urgent += '</div>';
										result_str_urgent += '</div>';
										result_str_urgent += '</div>';
