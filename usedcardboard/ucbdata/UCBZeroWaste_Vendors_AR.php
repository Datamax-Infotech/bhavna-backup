...
<div class="main_data_css">
		...
		<table border="0" cellspacing="1" cellpadding="1">
			...
			<tr >
				...
				<td align="left"> 
				    ...
				    <input type="text" name="flt_inv_due_dt" id="flt_inv_due_dt" size="10" value="<?=(isset($_REQUEST['flt_inv_due_dt']) ? $_REQUEST['flt_inv_due_dt'] : "01/01/2021"); ?>" > 
	...
	<table width="60%" border="0" cellspacing="1" cellpadding="1">
		...
		<tr class="display_maintitle" style="background: #ABC5DF;">
			<td>Sr.No</td>
