...
<table cellSpacing="1" cellPadding="1" width="500" border="0">
	<tr align="middle">
		<td colSpan="4" class="style1"><font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
		UPLOAD
		END OF DAY</font></td>
	</tr>
	<tr>
		...
		# of LABELS ON EOD REPORT</font></td>
		<td class="style5" style="width: 24%; height: 16px;"><font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
		#
		UPS PICKED UP</font></td>
	</tr>
...
if ($_GET['warehouse_name'] != '')
{
$thewarehouse = $_GET['warehouse_name'];
}
...
<script LANGUAGE="JavaScript">
	...
	cal2xx.showNavigationDropdowns();
		...
		<td bgColor="#e4e4e4" style="width: 7%" class="style10"><font face="Arial, Helvetica, sans-serif" color="#333333" size="1"> Date: <input type="text" name="search_date" size="11" value="<?php  echo date('m/d/y'); ?>"> <a href="#" onclick="cal1xx.select(document.rptSearch.search_date,'anchor1xx','MM/dd/yy'); return false;" name="anchor1xx" id="anchor1xx"><img border="0" src="images/calendar.jpg"></a></td>
...
<table cellSpacing="1" cellPadding="1" width="500" border="0">
	<tr align="middle">
		<td bgColor="#ffcccc" colSpan="4" class="style1"><font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
...
?>
	<tr vAlign="center">
		...
		<td align="middle" bgColor="#e4e4e4" style="width: 20%" class="style10">
		<a href="show_fax.php?file=<?php  echo $myrowsel3['file_name'] ?>">View</a></td>
	</tr>
<?php  } ?>
	</table>
