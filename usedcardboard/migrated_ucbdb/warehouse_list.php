...
<!--			<TD CLASS='<?php  echo $shade; ?>'>
			...
			<TD CLASS='<?php  echo $shade; ?>'><?php  if($prev_rank > 0) {?>
				<a href="warehouse_list_update_priority.php?id=<?php  echo $id; ?>&prank=<?php echo $prev_rank?>"><!-- Move Up --><strong><font size="+1">^</font></strong></a><?php  } ?> 
			</TD>						
...
/* FIX STRING */
$rank = FixString($rank);
		$distribution_center = FixString($distribution_center);
		$legalname = FixString($legalname);	
		$address_one = FixString($address_one);
		$address_two = FixString($address_two);
		$city = FixString($city);
...
/*-- SECTION: 9994SQL --*/
	$sql = "INSERT INTO ucbdb_warehouse (
rank,
distribution_center,
legalname,
address_one,
...
$qry = "SELECT MAX(rank) as maxrank FROM ucbdb_warehouse"; 
...
<!--	<TR>
		...
		<TD>
	<INPUT CLASS='TXT_BOX' type="text" NAME="rank" SIZE="20">
...
$sql = "UPDATE ucbdb_warehouse SET 
 rank='$rank',
...
<TD ><DIV CLASS='TBL_ROW_DATA'><?php  echo $rank; ?> </DIV></TD>
		<TR><TD CLASS='TBL_ROW_HDR'>DISTRIBUTION_CENTER:</TD>
<TD ><DIV CLASS='TBL_ROW_DATA'><?php  echo $distribution_center; ?> </DIV></TD>
		<TR><TD CLASS='TBL_ROW_HDR'>LEGAL NAME:</TD>
<TD ><DIV CLASS='TBL_ROW_DATA'><?php  echo $legalname; ?> </DIV></TD>
		<TR><TD CLASS='TBL_ROW_HDR'>ADDRESS_ONE:</TD>
<TD ><DIV CLASS='TBL_ROW_DATA'><?php  echo $address_one; ?> </DIV></TD>
		<TR><TD CLASS='TBL_ROW_HDR'>ADDRESS_TWO:</TD>
<TD ><DIV CLASS='TBL_ROW_DATA'><?php  echo $address_two; ?> </DIV></TD>
...
<TD ><DIV CLASS='TBL_ROW_DATA'><?php  echo $zip; ?> </DIV></TD>
		<TR><TD CLASS='TBL_ROW_HDR'>COUNTRY:</TD>
<TD ><DIV CLASS='TBL_ROW_DATA'><?php  echo $country; ?> </DIV></TD>
		<TR><TD CLASS='TBL_ROW_HDR'>PHONE:</TD>
<TD ><DIV CLASS='TBL_ROW_DATA'><?php  echo $phone; ?> </DIV></TD>
		<TR><TD CLASS='TBL_ROW_HDR'>FAX:</TD>
<TD ><DIV CLASS='TBL_ROW_DATA'><?php  echo $fax; ?> </DIV></TD>
		<TR><TD CLASS='TBL_ROW_HDR'>EOD_TIME:</TD>
<TD ><DIV CLASS='TBL_ROW_DATA'><?php  echo $eod_time; ?> </DIV></TD>
