...
?>
 ...
 <div align="center">
   ...
   <table border="0" width="266">
     <tr>
       <td width="266"><font face="Arial" size="2">David - Enter Tracking Number</font>
 <br>
...
<br>
Tracking Number: <?php  echo $_POST['tracknum'] ?></font><br>

</font><font color="#000000" size="1" face="Verdana"> <?php  echo $stat ?> </font><font color="#FFFFFF" size="2" face="Verdana"> <br>

</font><font color="#000000" size="1" face="Verdana"><?php  if($seventeen == "D"){echo("Left at: $fourteen");} ?></font></b><br>

<font size="1" face="Verdana">Shipping Method:</b></font> <font face="Verdana" size="1" color="#000000"><?php  echo $thirteen ?></font><br>

<font size="1" face="Verdana">Weight:</b></font> <font face="Verdana" size="1" color="#000000"><?php  echo "$eleven $twelve" ?></font><br>

<font face="Verdana" size="2" color="#FFFFFF"><b><i>Destined for:</i></font></b> <font color="#000000" size="1" face="Verdana"><b><?php  echo "$monthx/$dayx/$yearx" ?></font> - <font color="#000000" size="1" face="Verdana"><?php  echo "$hhx:$mmx:$ssx" ?></b></font></font><br>

<b><font face="Verdana" size="1"><?php  if($stat == "I"){$sixteen = trim($sixteen);echo("$sixteen");}else{$sixteen = trim($sixteen);echo("$sixteen");} ?>:</font></b>
<br>
<font face="Verdana" color="#000000" size="1"><?php  if($eighteen){echo("$eighteen, ");}if($twenty){echo("$twenty ");}if($nineteen){echo("$nineteen");} ?></font>
<br>
<font face="Verdana" size="2"><b><?php  if($seventeen == "D"){echo("Signed for by: $fifteen");} ?></b></font>
