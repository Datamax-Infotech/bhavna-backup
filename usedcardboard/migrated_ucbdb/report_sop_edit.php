...
<span class="style2">
<!--<a href="index.php">Home</a> - --><a href="report_sop.php?action=run&employee=<?php echo $_REQUEST["backemployee"]?>&division=<?php echo $_REQUEST["backdivision"]?>&department=<?php echo $_REQUEST["backdepartment"]?>&frequency=<?php echo $_REQUEST["backfrequency"]?>&search=<?php echo $_REQUEST["backsearch"]?>&id=<?php echo $_REQUEST["id"]?>">Back</a></span>
<br>
...
&nbsp; <input type="submit" value="   UPDATE TASK    "></form>
