...
<body>
	...
	$thispage	= "manage_sortwh.php"; //SET THIS TO THE NAME OF THIS FILE
	...
	?>
		...
		if ($_REQUEST['posting'] == "yes") {
			...
			if ($searchcrit == "") {
				...
				$sqlwhere = " company_name like '%$searchcrit%' OR company_address1 like '%$searchcrit%' OR company_address2 like '%$searchcrit%' OR 
 company_city like '%$searchcrit%' OR company_state like '%$searchcrit%' OR company_zip like '%$searchcrit%' OR company_phone like '%$searchcrit%' OR 
 company_email like '%$searchcrit%' OR company_terms like '%$searchcrit%' OR company_contact like '%$searchcrit%' OR warehouse_name like '%$searchcrit%' OR 
 warehouse_address1 like '%$searchcrit%' OR warehouse_address2 like '%$searchcrit%' OR warehouse_city like '%$searchcrit%' OR warehouse_state like '%$searchcrit%' OR 
 warehouse_zip like '%$searchcrit%' OR warehouse_contact like '%$searchcrit%' OR warehouse_contact_phone like '%$searchcrit%' OR warehouse_contact_email like '%$searchcrit%' OR 
 warehouse_manager like '%$searchcrit%' OR warehouse_manager_phone like '%$searchcrit%' OR warehouse_manager_email like '%$searchcrit%' OR dock_details like '%$searchcrit%' OR 
 warehouse_notes like '%$searchcrit%' OR other1 like '%$searchcrit%' OR other2 like '%$searchcrit%' OR other3 like '%$searchcrit%' 
"; //FINISH SQL STRING
			} //END IF SEARCHCRIT = "";
					...
					?>
						...
						if ($proc == "New") {
							...
							if ($post == "yes") {
								...
								/*-- SECTION: 9994SQL --*/
								$sql = "INSERT INTO loop_warehouse ( company_name, company_address1, company_address2, company_city, company_state,
								company_zip,company_phone, company_email,company_terms,company_contact,warehouse_name,warehouse_address1,warehouse_address2,
								...
								warehouse_manager_phone, warehouse_manager_email,dock_details,warehouse_notes,rec_type,bs_status,other1,other2,other3
								$addl_insert_crit ) VALUES ( '$company_name', '$company_address1', '$company_address2','$company_city','$company_state',
								'$company_zip','$company_phone','$company_email','$company_terms','$company_contact','$warehouse_name','$warehouse_address1',
								'$warehouse_address2','$warehouse_city','$warehouse_state','$warehouse_zip','$warehouse_contact','$warehouse_contact_phone',
								'$warehouse_contact_email','$warehouse_manager','$warehouse_manager_phone','$warehouse_manager_email','$dock_details','$warehouse_notes',
								'$rec_type','$bs_status','$other1','$other2', '$other3' $addl_insert_values )";
								if ($sql_debug_mode == 1) {
									echo "<BR>SQL: $sql<BR>";
								}
								$result = db_query($sql);
								if (empty($result)) {
									...
									if (!headers_sent()) {    //If headers not sent yet... then do php redirect
										header('Location: manage_sortwh.php?posting=yes');
										exit;
									} else {
					...
					?>
						...
						if ($proc == "Edit") {
							...
							if ($_REQUEST['post'] == "yes") {
								...
								warehouse_manager='$warehouse_manager', warehouse_manager_phone='$warehouse_manager_phone',warehouse_manager_email='$warehouse_manager_email',
								dock_details='$dock_details',warehouse_notes='$warehouse_notes',other1='$other1', other2='$other2',other3='$other3'
