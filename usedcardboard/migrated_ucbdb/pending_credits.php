...
?>
			...
			<TD CLASS='<?php  echo $shade; ?>'>
				<a href="orders.php?id=<?php  echo $orders_id; ?>&proc=View"><?php  echo $orders_id; ?></a> 
			</TD>
			...
			<TD CLASS='<?php  echo $shade; ?>'>
				...
				<a href="<?php  echo $thispage; ?>?id=<?php  echo $id; ?>&proc=Delete&<?php  echo $pagevars; ?>&orders_id=<?php  echo $orders_id; ?>">Remove</a>
				<?php  } ?>
				</DIV>
			</TD>
		</TR>
...
$result3 = db_query($sql3,db() );	
	...
	if (!headers_sent()){    //If headers not sent yet... then do php redirect
        header('Location: http://b2c.usedcardboardboxes.com/pending_credits.php?posting=yes&'); exit;
}
else
{
