		...
		?>
			<table cellSpacing="1" cellPadding="1" width="500" border="0">
				...
				if ($start_date > $end_date) {
					echo "<font size=20>The start date comes after the end date.  This could never happen in reality.  Please try again.<br><br></font>";
					exit;
				}
				...
				?>
					<tr>
						<td class="style7" colspan="6" align="center">
							<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">Module Type: <?php echo $mod_row['name']; ?></font>
						</td>
					</tr>
					...
					while ($war_row = array_shift($war_res)) {
						...
						$sql_5_res = db_query($sql_5);
						$sql_5_rows = tep_db_num_rows($sql_5_res);
					?>
						<tr>
							<td class="style11">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
									<?php echo $warehouse; ?></font>
							</td>
							<td class="style11">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
									<a href="report_ups_status_drill.php?warehouse_id=<?php echo encrypt_url($war_row['warehouse_id']); ?>&module_name=<?php echo $mod_row['name']; ?>&status=Manifest Pickup<?php if ($_GET['start_date'] != '') {
																																																					echo "&start_date=" . $start_date;
																																																				} ?>
																																																	<?php if ($_GET['end_date'] != '') {
																																																		echo "&end_date=" . $end_date;
																																																	} ?>"><?php echo $sql_1_rows; ?></a>
								</font>
							</td>
							<td class="style11">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
									<a href="report_ups_status_drill.php?warehouse_id=<?php echo encrypt_url($war_row['warehouse_id']); ?>&module_name=<?php echo $mod_row['name']; ?>&status=In Transit<?php if ($_GET['start_date'] != '') {
																																																			echo "&start_date=" . $start_date;
																																																		} ?><?php if ($_GET['end_date'] != '') {
																																																	echo "&end_date=" . $end_date;
																																																} ?>"><?php echo $sql_2_rows; ?></a>
								</font>
							</td>
							<td class="style11">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
									<a href="report_ups_status_drill.php?warehouse_id=<?php echo encrypt_url($war_row['warehouse_id']); ?>&module_name=<?php echo $mod_row['name']; ?>&status=Exception<?php if ($_GET['start_date'] != '') {
																																																			echo "&start_date=" . $start_date;
																																																		} ?><?php if ($_GET['end_date'] != '') {
																																																	echo "&end_date=" . $end_date;
																																																} ?>"><?php echo $sql_3_rows; ?></a>
								</font>
							</td>
							<td class="style11">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
									<a href="report_ups_status_drill.php?warehouse_id=<?php echo encrypt_url($war_row['warehouse_id']); ?>&module_name=<?php echo $mod_row['name']; ?>&status=Delivered<?php if ($_GET['start_date'] != '') {
																																																			echo "&start_date=" . $start_date;
																																																		} ?><?php if ($_GET['end_date'] != '') {
																																																	echo "&end_date=" . $end_date;
																																																} ?>"><?php echo $sql_4_rows; ?></a>
								</font>
							</td>
							<td class="style11">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
									<?php echo ($sql_1_rows + $sql_2_rows + $sql_3_rows + $sql_4_rows); ?>
								</font>
							</td>
							<td class="style11">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
