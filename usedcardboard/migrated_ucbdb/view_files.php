...
<tr><td>Date</td><td><font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
...
and
<font face="Arial, Helvetica, sans-serif" color="#333333" size="1"><input type="text" name="end_date" size="11" value="<?php echo (isset($_GET["end_date"]) && $_GET["end_date"] != "")?date('m/d/Y', $end_date):""?>"> <a href="#" onclick="cal1xx.select(document.rptSearch.end_date,'anchor2xx','MM/dd/yyyy'); return false;" name="anchor2xx" id="anchor2xx"><img border="0" src="images/calendar.jpg"></a> 

</td></tr>
<tr><td>or</td><td> </td>
<tr><td>Search:</td><td><input type=text name="searchterm" length=60></td>
</table>

&nbsp; <br><input type="hidden" name="run" value="1"><input type="submit" value="View Files"></form>
...
if ($_REQUEST["run"] > 0)
{
	...
	{
	?>
		<tr><td width="20%"><?php echo $row["B"];?></td><td width="20%"><?php echo $row["D"];?></td><td width="20%"><?php echo $row["C"];?></td><td width="20%"><?php echo $row["E"];?></td><td width="20%"><a  href="" onMouseOver="shamwow('<?php echo $row["A"];?>');return true;" >view</a></td></tr>
