	...
	<div class="main_data_css">
		...
		?>
			<table WIDTH='100%'>
				...
				<tr>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Order ID</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Shopify Order ID</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Order Amount</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Payment Method</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Order Date</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Customer IP Address</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Customer Name</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Address One</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Address Two</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>City</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>State</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Zip Code</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Phone</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Email</DIV>
					</TD>

					<TD>
						<DIV CLASS='TBL_COL_HDR'>Survey</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Notes</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Update Survey Response</DIV>
					</TD>
				</tr>
				<?php
				...
				?>
					<tr>
						<TD CLASS='<?php echo $shade; ?>'>
							<a target="_blank" href="orders.php?id=<?php echo encrypt_url($myrowsel['orders_id']); ?>&proc=View&searchcrit=&page=0">
		...
		?>
			<table WIDTH='100%'>
				...
				<tr>
					...
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Contacted By</DIV>
					</TD>
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Contacted On</DIV>
					</TD>
				</tr>
				<?php
		...
		?>
			<table WIDTH='100%'>
				...
				<tr>
					...
					<TD>
						<DIV CLASS='TBL_COL_HDR'>Survey Email Sent on</DIV>
					</TD>
				</tr>
				<?php
