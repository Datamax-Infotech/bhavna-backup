...
require '../ucbloop/phpmailer/PHPMailerAutoload.php';
	...
	function send_email($emailaddress, $customer_name, $shopify_order_no, $qualifier) 
	{
		//Code to send mail
	...
	function sendemail_withattachment_byphpemail_new($files, $path, $mailto, $scc, $sbcc, $from_mail, $from_name, $replyto, $subject, $message) 
	{
		//Code to send mail
...
db();
$dt = mktime(0,0,0,date('m'),(date('d')-8),date('Y')); 
...
//$query = "SELECT orders_id, customers_name, customers_email_address, shopify_order_display_no, survey FROM orders WHERE orders_id in (394419, 394418)";
//echo $query;
...
while ($row = array_shift($run_query)) {
	...
	if ($emailaddress != ""){
		//echo "An email will be sent to: " . $firstname . " with Order ID multiplied by 7 equaling  " . $qualifier . " to email address: " . $emailaddress . "<br>";

/*		$srvmail_msg = "<html><head></head><body bgcolor=\"#E7F5C2\"><table align=\"center\" cellpadding=\"0\"><tr><td colspan=\"2\"><p align=\"center\"><a href=\"http://www.usedcardboardboxes.com/index.php\"><img src=\"http://www.usedcardboardboxes.com/images/ucb-banner1.jpg\" width=\"650\" height=\"166\" border=\"0\"></a></p></td></tr><tr><td width=\"23\"><p> </p></td><td width=\"682\"><p><br><font face=\"arial\" size=\"2\">Dear " . $firstname . ":</font></p><p><font face=\"arial\" size=\"2\">My name is Marty Metro and I am Founder and CEO of UsedCardboardBoxes.com. I sincerely appreciate your business and feel honored by our tens of thousands of customers that believe in supporting good companies trying to do great things. By now you should have received your moving boxes and I&rsquo;m sure you have been busy packing up your home. I would like to personally ask for two minutes of your time to fill out our online survey so that we can continue to improve our products and services. I personally read every survey response and have implemented many suggestions from our customers, to date. I love to hear the compliments, but it&rsquo;s the suggestions that help us get even better. I know we aren&rsquo;t perfect, but I can assure you it isn&rsquo;t for lack of trying!</font></p><p><font size=\"2\" face=\"Arial, Helvetica, sans-serif\">Please click here to complete our survey: <a href=\"https://business.usedcardboardboxes.com/survey.php?q=" . $qualifier . "\">https://business.usedcardboardboxes.com/survey.php</a></font></p><p><font size=\"2\" face=\"Arial, Helvetica, sans-serif\">Thank you for your time and support!</font></p><p><font size=\"2\" face=\"Arial, Helvetica, sans-serif\"> Best regards, </font></p><p><font size=\"2\" face=\"Arial, Helvetica, sans-serif\">  Marty Metro <br>Founder / CEO <br>UsedCardboardBoxes.com <br>4032 Wilshire Blvd.<br>Suite #402<br>Los Angeles, CA 90010 <br>Toll Free: 1-888-BOXES-88<br>Office: 323-724-2500<br><br></font></p></td></tr><tr><td colspan=\"2\"><p align=\"center\"><img width=\"650\" height=\"87\" src=\"http://www.usedcardboardboxes.com/images/ucb-footer1.jpg\"></p></td></tr><tr><td width=\"23\"><p>&nbsp; </p></td><td width=\"682\"><p>&nbsp; </p></td></tr></table></body></html>";

		$srvmail_msg_notify = "An email was sent to: " . $firstname . " with Order ID multiplied by 7 equaling  " . $qualifier . " to email address: " . $emailaddress;

		$mailheaders = "MIME-Version: 1.0\r\n";
		$mailheaders.= "Content-Type: text/html; charset=ISO-8859-1\r\n";
		$mailheaders.= "From:UsedCardboardBoxes.com\n";
		$mailheaders.= "Reply-To:info@usedcardboardboxes.com\n\n";
		$mailheadersadmin="From:UsedCardboardBoxes.com\n";
			
		$resp =	sendemail_withattachment_byphpemail_new(array(), "", $emailaddress, "", "", "ucbemail@usedcardboardboxes.com", "UsedCardboardBoxes.com", "info@usedcardboardboxes.com", "A Personal Request from the CEO of UsedCardboardBoxes.com", $srvmail_msg);		
	*/
