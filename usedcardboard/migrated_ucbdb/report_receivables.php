...
?>
	...
	<tr>
		...
		<a href=http://loops.usedcardboardboxes.com/search_results.php?id=<?php echo $row["id"]?>&proc=View&rec_type=Supplier&page=0" target=_blank><?php echo $row["company_name"]?></a></font></td>
		<td class="style5" style="width: 20%">
		<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">		
		<?php echo Number_format($inv,2)?></td>
		<td class="style5" style="width: 20%">
		<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">		
		<?php echo Number_format($amount2,2)?></td>
		<td class="style5" style="width: 20%">
		<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">		
		<?php echo Number_format($inv-$amount2,2)?></td>
