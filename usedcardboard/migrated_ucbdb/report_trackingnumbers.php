		...
		<table cellSpacing="1" cellPadding="1" width="500" border="0">
			...
			<tr>
				<td style="width: 15%" class="style17">
					<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">DATE</font>
				</td>
				<td style="width: 15%" class="style17">
					<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">ORDER ID</font>
				</td>
				<td class="style5" style="width: 50%">
					<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">NAME</font>
				</td>
				<td align="middle" style="width: 20%" class="style16">
					<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">AMOUNT</font>
				</td>
			</tr>
			<?php
			$referrer = $_GET['referrer'];
