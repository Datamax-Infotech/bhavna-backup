...
<input type=radio <?php if($_GET["surveyview"] == "1" || $_GET["surveyview"] == ""){echo "checked";}?> name="surveyview" value="1">Show All <input type=radio name="surveyview"<?php if($_GET["surveyview"] == "0"){echo "checked";}?> value="0">Show Uncategorized
	...
	?>
		<tr vAlign="center">
			...
			while($option_select = array_shift($opt))
			{
			 ...
			 ?></select></td>
			<td bgColor="#e4e4e4" class="style3"><font face="Arial, Helvetica, sans-serif" color="#333333" size="1">	
			<select name="cat2<?php  echo $row["id"] ?>" <option value="0" ?>" <option value="0" ?>" <option value="0" ?>"<option value=0>Please Select</option><?php  
			$opt = db_query("Select * FROM survey_categories ORDER BY dropdown",db());
			while($option_select = array_shift($opt))
			{
			 ...
			 ?></select></td>
			 <td bgColor="#e4e4e4" class="style3"><font face="Arial, Helvetica, sans-serif" color="#333333" size="1">	
			 <input type=text size=30 name="cat2<?php  echo $row["id"] ?>" value="<?php  echo $row["notes"]; ?>" ?>" value="<?php  echo $row["notes"]; ?>"> </td ?>
