...
<body>
	...
	<div class="main_data_css">
				...
				<tr>
					...
					<td>
						<select name="list_warehouse" name="list_warehouse">
							...
							<option value="hv" <?php if ($_REQUEST["list_warehouse"] == "hv") {
													echo " selected ";
												} ?>>HV</option>
							<option value="ha" <?php if ($_REQUEST["list_warehouse"] == "ha") {
													echo " selected ";
												} ?>>HA</option>
							<option value="sl" <?php if ($_REQUEST["list_warehouse"] == "sl") {
													echo " selected ";
												} ?>>SL</option>
							<option value="la" <?php if ($_REQUEST["list_warehouse"] == "la") {
													echo " selected ";
												} ?>>LA</option>
						</select>
					</td>
		...
		<div>
			<i>Red rows means >5 days as Order Issue</i>
		</div>
		...
		<?php if (isset($_REQUEST["date_from"]) || $_REQUEST["onlyactive_orders"] == "yes") {
			$in_dt_range = "no";
			$date_to_val = strtotime(date('m/d/Y'));
			$date_from_val = strtotime(date('m/d/Y'));
			...
			function getreportdata(int $eid, string $so_val, string $sk_val, string $dt_from, string $dt_to, bool $onlyactive_orders): void
			{
		...
		?>
				<table width="1200px" border="0" cellspacing="1" cellpadding="1">
					<tr>
						<td colspan="15" align="center" bgcolor="#D9F2FF">
							<font face="Arial, Helvetica, sans-serif" size="2" color="#333333"><b>Order Issues Report</b></font>
						</td>
					</tr>
					<?php
					...
					?>
					<tr>
						<td width="50px" bgcolor="#D9F2FF">
							<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Order ID&nbsp;<a href="<?php echo $sorturl; ?>&order_id=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&order_id=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a></font>
						</td>

						<td width="100px" bgcolor="#D9F2FF">
							<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Warehouse&nbsp;<a href="<?php echo $sorturl; ?>&warehouse=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&warehouse=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a></font>
						</td>

						<td width="150px" bgcolor="#D9F2FF">
							<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Name&nbsp;<a href="<?php echo $sorturl; ?>&comp_name=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&comp_name=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a></font>
						</td>

						<td width="20px" bgcolor="#D9F2FF" align="center">
							<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Order Amount&nbsp;<a href="<?php echo $sorturl; ?>&po_amount=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&po_amount=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a></font>
						</td>

						<td width="50px" bgcolor="#D9F2FF" align="center">
							<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Order Issue flag Marked By&nbsp;<a href="<?php echo $sorturl; ?>&employee_id=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&employee_id=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
							</font>
						</td>
						<td width="200px" bgcolor="#D9F2FF" align="center">
							<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Notes - when marked as order issue&nbsp;<a href="<?php echo $sorturl; ?>&trans_log_mark=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&trans_log_mark=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
							</font>
						</td>
						<td width="120px" bgcolor="#D9F2FF" align="center">
							<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Marked as order issue on&nbsp;<a href="<?php echo $sorturl; ?>&order_issue_date=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&order_issue_date=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
							</font>
						</td>
						<td width="50px" bgcolor="#D9F2FF" align="center">
							<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Order Issue flag UnMarked By&nbsp;<a href="<?php echo $sorturl; ?>&employee_id_unmark=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&employee_id_unmark=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
							</font>
						</td>
						<td width="200px" bgcolor="#D9F2FF" align="center">
							<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Notes - when unmarked as order issue&nbsp;<a href="<?php echo $sorturl; ?>&trans_log_unmark=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&trans_log_unmark=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
							</font>
						</td>
						<td width="100px" bgcolor="#D9F2FF" align="center">
							<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">UnMarked as order issue on&nbsp;<a href="<?php echo $sorturl; ?>&un_order_issue_date=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&un_order_issue_date=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
							</font>
						</td>
						<td width="50px" bgcolor="#D9F2FF" align="center">
							<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Days as an order issue&nbsp;<a href="<?php echo $sorturl; ?>&days_ano_order_issue=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&days_ano_order_issue=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
							</font>
						</td>

						<td width="70px" bgcolor="#D9F2FF" align="center">
							<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Order issue Estimated Cost&nbsp;<a href="<?php echo $sorturl; ?>&est_cost=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&est_cost=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
							</font>
						</td>
						<td width="70px" bgcolor="#D9F2FF" align="center">
							<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Order issue Reason&nbsp;<a href="<?php echo $sorturl; ?>&reason=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&reason=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
							</font>
						</td>
					...
					if (!isset($_REQUEST["sort"])) {
						...
						while ($data = array_shift($data_res)) {
							...
							$order_issue_reason = "";
							$data_res1 = db_query("Select * from loop_order_issue_reason where reason_id = '" . $data["order_issue_reason_id"] . "'");
							...
							$la_flg = "no";
							$sl_flg = "no";
							$data_res1 = db_query("Select * from ucbdb_warehouse");
							while ($data1 = array_shift($data_res1)) {
								if ($data1["tablename"] != "") {
									$data_res2 = db_query("SELECT * FROM " . $data1["tablename"] . " WHERE orders_id = '" . $data["orders_id"] . "' limit 1");
							...
							if ($show_row == "yes") {
								...
								$trans_log_mark_date = "";
								$employee_id_mark = 0;
								$employee_id_unmark = 0;
								$trans_log_unmark = "";
								$trans_log_unmark_date = "";
					...
					?>
								<tr valign="middle">
									<td width="50px" bgcolor="<?php echo $rowcolor ?>"><a target="_blank" href="orders.php?id=<?php echo encrypt_url($data["orders_id"]); ?>&proc=View&searchcrit=<?php echo $data["orders_id"] ?>&page=0">
											<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $data["orders_id"] ?></font>
										</a></td>

									<td width="100px" bgcolor="<?php echo $rowcolor ?>">
										<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $warehouse_str; ?></font>
									</td>

									<td width="150px" bgcolor="<?php echo $rowcolor ?>">
										<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $data["customers_name"]; ?></font>
									</td>

									<td width="20px" bgcolor="<?php echo $rowcolor ?>" align="center">
										<font face="Arial, Helvetica, sans-serif" size="1" color="#333333">$<?php echo $order_amount ?></font>
									</td>

									<td width="20px" bgcolor="<?php echo $rowcolor ?>" align="center">
										<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $emp_initials_mark; ?></font>
									</td>

									<td width="200px" bgcolor="<?php echo $rowcolor ?>" align="center">
										<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $trans_log_mark ?></font>
									</td>

									<td width="100px" bgcolor="<?php echo $rowcolor ?>" align="center">
										<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $data["order_issue_start_date_time"] ?></font>
									</td>

									<td width="20px" bgcolor="<?php echo $rowcolor ?>" align="center">
										<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $emp_initials_unmark; ?></font>
									</td>

									<td width="200px" bgcolor="<?php echo $rowcolor ?>" align="center">
										<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $trans_log_unmark ?></font>
									</td>

									<td width="100px" bgcolor="<?php echo $rowcolor ?>" align="center">
										<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $order_issue_end_date_time ?></font>
									</td>

									<td width="50px" bgcolor="<?php echo $rowcolor ?>" align="center">
										<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $mark_unmark_day ?></font>
									</td>

									<td width="50px" bgcolor="<?php echo $rowcolor ?>" align="center">
										<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $data["order_issue_estimated_cost"] ?></font>
									</td>

									<td width="50px" bgcolor="<?php echo $rowcolor ?>" align="center">
										<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $order_issue_reason ?></font>
									</td>
							...
							<?php
								...
								$MGArray_data[] = array(
									'emp_initials_mark' => $emp_initials_mark, 'warehouse_str' => $warehouse_str, 'emp_initials_unmark' => $emp_initials_unmark,
					...
					if (isset($_REQUEST["sort"])) {
						...
						$vc_array_compid = array();
						$vc_array_estimated_cost = array();
						$vc_array_nickname = array();
						$vc_array_po_poorderamount = array();
						$vc_array_trans_log_mark = array();
						$vc_array_trans_log_unmark = array();
						$vc_array_mark_unmark_day = array();
						$vc_array_employee_id = array();
						$vc_array_employee_id_unmark = array();
						$vc_array_warehouse_str = array();
						$vc_array_estimated_cost = array();
						$vc_array_reason = array();
						$vc_array_mark_on = array();
						$vc_array_un_mark_on = array();
						...
						foreach ($MGArray_data as $MGArraytmp2) {
							?>
							<tr valign="middle">
								<td width="50px" bgcolor="<?php echo $rowcolor ?>"><a target="_blank" href="orders.php?id=<?php echo encrypt_url($MGArraytmp2["orders_id"]); ?>&proc=View&searchcrit=<?php echo $MGArraytmp2["orders_id"] ?>&page=0">
										<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["orders_id"] ?></font>
									</a></td>

								<td width="150px" bgcolor="<?php echo $rowcolor ?>">
									<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["warehouse_str"]; ?></font>
								</td>

								<td width="150px" bgcolor="<?php echo $rowcolor ?>">
									<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["name"]; ?></font>
								</td>

								<td width="20px" bgcolor="<?php echo $rowcolor ?>" align="center">
									<font face="Arial, Helvetica, sans-serif" size="1" color="#333333">$<?php echo number_format($MGArraytmp2["orderamount"], 2) ?></font>
								</td>

								<td width="20px" bgcolor="<?php echo $rowcolor ?>" align="center">
									<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["emp_initials_mark"]; ?></font>
								</td>

								<td width="200px" bgcolor="<?php echo $rowcolor ?>" align="center">
									<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["trans_log_mark"]; ?></font>
								</td>

								<td width="100px" bgcolor="<?php echo $rowcolor ?>" align="center">
									<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["order_issue_start_date_time"]; ?></font>
								</td>

								<td width="20px" bgcolor="<?php echo $rowcolor ?>" align="center">
									<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["emp_initials_unmark"]; ?></font>
								</td>

								<td width="200px" bgcolor="<?php echo $rowcolor ?>" align="center">
									<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["trans_log_unmark"]; ?></font>
								</td>

								<td width="100px" bgcolor="<?php echo $rowcolor ?>" align="center">
									<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["order_issue_end_date_time"]; ?></font>
								</td>

								<td width="50px" bgcolor="<?php echo $rowcolor ?>" align="center">
									<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["mark_unmark_day"]; ?></font>
								</td>

								<td width="50px" bgcolor="<?php echo $rowcolor ?>" align="center">
									<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["order_issue_estimated_cost"]; ?></font>
								</td>

								<td width="50px" bgcolor="<?php echo $rowcolor ?>" align="center">
									<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["order_issue_reason"]; ?></font>
								</td>
					...
					if (tep_db_num_rows($data_res) > 0) {
						...
						<table width="250px" border="0" cellspacing="1" cellpadding="1">
							...
							<tr>
								<td colspan="3" align="center" bgcolor="#D9F2FF">
									<font face="Arial, Helvetica, sans-serif" size="2" color="#333333"><b>Order Issues Report - Summary</b></font>
								</td>
							</tr>
							<tr>
								<td width="50px" bgcolor="#D9F2FF">
									<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Employee </font>
								</td>
						...
						<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Count (Transaction Log - when unmarked as order issue)
							...
							<tr>
								<td width="50px" bgcolor="#D9F2FF">
									<font size="1" face="Arial, Helvetica, sans-serif" color="#333333"><b>
											Operations</b>
									</font>
								</td>
					...
					<table width="350px" border="0" cellspacing="1" cellpadding="1">
						...
						<tr>
							<td colspan="2" align="center" bgcolor="#D9F2FF">
								<font face="Arial, Helvetica, sans-serif" size="2" color="#333333"><b>Order Issue Warehouse Summary</b></font>
							</td>
						</tr>
						<tr>
							<td width="250px" bgcolor="#D9F2FF">
								<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Order Issue Warehouse</font>
							</td>

							<td width="100px" bgcolor="#D9F2FF" align="center">
								<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Count</font>
							</td>
						</tr>
						<tr>
							<td width="250px" bgcolor="#D9F2FF">
								<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">HV</font>
							</td>
							<td width="100px" bgcolor="#D9F2FF" align="center">
								<font size=1><?php echo $hv_count; ?></font>
							</td>
						</tr>
						<tr>
							<td width="250px" bgcolor="#D9F2FF">
								<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">HA</font>
							</td>
							<td width="100px" bgcolor="#D9F2FF" align="center">
								<font size=1><?php echo $ha_count; ?></font>
							</td>
						</tr>
						<tr>
							<td width="250px" bgcolor="#D9F2FF">
								<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">SL</font>
							</td>
							<td width="100px" bgcolor="#D9F2FF" align="center">
								<font size=1><?php echo $salt_lake_count; ?></font>
							</td>
						</tr>
						<tr>
							<td width="250px" bgcolor="#D9F2FF">
								<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">LA</font>
							</td>
							<td width="100px" bgcolor="#D9F2FF" align="center">
								<font size=1><?php echo $la_count; ?></font>
							</td>
						</tr>
					</table>
					...
					<table width="350px" border="0" cellspacing="1" cellpadding="1">
						...
						<tr>
							<td colspan="2" align="center" bgcolor="#D9F2FF">
								<font face="Arial, Helvetica, sans-serif" size="2" color="#333333"><b>Order Issue Reason Summary</b></font>
							</td>
						</tr>
						<tr>
							<td width="250px" bgcolor="#D9F2FF">
								<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Order Issue Reason</font>
							</td>
