		...
		<table border="0" cellpadding="5" cellspacing="2" width="80%" align="center">
			<tr>
				...
				<td valign="top">
					...
					<!--<form action="contact_archve_status_drill.php">
<table cellSpacing="1" cellPadding="1" width="200" border="0">
	<tr align="middle">
		<td bgColor="#ffcccc" colSpan="2" class="style9">
		<font face="Arial, Helvetica, sans-serif" color="#333333">
		<strong>CONTACT RECORD SEARCH</strong></font></td>
	</tr>
	<tr vAlign="center">
		<td align="left" bgColor="#e4e4e4" style="width: 4%"><input type="hidden" name="posting" value="yes"><input type="textbox" name="searchcrit" size="20"></td>
		<td align="middle" bgColor="#e4e4e4" style="width: 13%"><input type="submit" name="B1" value="Find"></td>
	</tr>
	<tr vAlign="center">
		<td align="center" bgColor="#e4e4e4" colspan="2" class="style12">Click "Find" to view all records</td>
	</tr>	
</table>
</form>
<br>-->
					...
					<table cellSpacing="1" cellPadding="1" width="200" border="0">
						...
						<tr vAlign="center">
							<td bgColor="#d9f2ff" style="width: 6%" class="style1">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">Year to Date <?php echo date("Y"); ?>
							</td>
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
						...
						<tr vAlign="center">
							<td bgColor="#d9f2ff" style="width: 6%" class="style1">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">Year <?php echo date("Y", strtotime("-1 year")) ?>
							</td>
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<?php
								// Year 2020
						...
						<tr vAlign="center">
							<td bgColor="#d9f2ff" style="width: 6%" class="style1">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">Year <?php echo date("Y", strtotime("-2 year")) ?>
							</td>
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<?php
								// Year 2019
						...
						<tr vAlign="center">
							<td bgColor="#d9f2ff" style="width: 6%" class="style1">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">Year <?php echo date("Y", strtotime("-3 year")) ?>
							</td>
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<?php
								// Year 2018
						...
						<tr vAlign="center">
							<td bgColor="#d9f2ff" style="width: 6%" class="style1">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">Year <?php echo date("Y", strtotime("-4 year")) ?>
							</td>
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<?php
								// Year 2017
...
*/
					...
					<table cellSpacing="1" cellPadding="1" width="200" border="0">
						...
						<tr vAlign="center">
							...
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($quota_ov_tod, 0); ?></font>
							</td>
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($total_revenue_tod, 0); ?></font>
							</td>
						</tr>
						<tr vAlign="center">
							<td bgColor="#d9f2ff" style="width: 6%" class="style1">
							...
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($quota_ov_tod_yesterday, 0); ?></font>
							</td>
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($total_revenue_yes, 0); ?></font>
							</td>
						</tr>
						<tr vAlign="center">
							<td bgColor="#d9f2ff" style="width: 6%" class="style1">
							...
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($quota_ov_tod_mtd, 0); ?></font>
							</td>
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($total_revenue_mtd, 0); ?></font>
							</td>
						</tr>
						<tr vAlign="center">
							<td bgColor="#d9f2ff" style="width: 6%" class="style1">
							...
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($quota_ov_tod_mtd1, 0); ?></font>
							</td>
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($total_revenue_mtdl, 0); ?></font>
							</td>
						</tr>
						<tr vAlign="center">
							<td bgColor="#d9f2ff" style="width: 6%" class="style1">
							...
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($quota_ov_tod_qtr, 0); ?></font>
							</td>
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($total_revenue_qtr, 0); ?></font>
							</td>
						</tr>
						<tr vAlign="center">
							<td bgColor="#d9f2ff" style="width: 6%" class="style1">
							...
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($quota_ov_tod_qtr1, 0); ?></font>
							</td>
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($total_revenue_qtrl, 0); ?></font>
							</td>
						</tr>
						<tr vAlign="center">
							<td bgColor="#d9f2ff" style="width: 6%" class="style1">
							...
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($quota_ov_tod_ytd, 0); ?></font>
							</td>
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($total_revenue_ytd, 0); ?></font>
							</td>
						</tr>
						<tr vAlign="center">
							<td bgColor="#d9f2ff" style="width: 6%" class="style1">
							...
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($quota_ov_tod_ytd1, 0); ?></font>
							</td>
							<td bgColor="#e4e4e4" style="width: 6%" class="style1" align="right">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">$<?php echo number_format($total_revenue_ytdl, 0); ?></font>
							</td>
						</tr>
					...
					<table cellSpacing="1" cellPadding="1" border="0" width="200">
						...
						<tr>
							...
							<td bgColor="#e4e4e4" class="style12" style="width: 10%">
								<a href="ups_status_report.php?status=Z"><?php echo $cntZ; ?></a>
							</td>
						</tr>
						...
						<tr>
							...
							<td bgColor="#e4e4e4" class="style12" style="width: 10%">
								<a href="ups_status_report.php?status=M"><?php echo $cntM; ?></a>
							</td>
				</td>
			</tr>
			...
			<tr>
				...
				<td bgColor="#e4e4e4" class="style12" style="width: 10%">
					<a href="ups_status_report.php?status=I"><?php echo $cntI; ?></a>
				</td>
			</tr>
			...
			<tr>
				...
				<td bgColor="#e4e4e4" class="style12" style="width: 10%">
					<a href="ups_status_report.php?status=X"><?php if ($cntX > 0) {
			...
			<tr>
				...
				<td bgColor="#e4e4e4" class="style12" style="width: 10%">
					<a href="ups_status_report.php?status=TN_No_Shopify"><?php echo $cntTN_No_Shopify; ?></a>
				</td>
			</tr>
			...
			<tr>
				<td bgColor="#e4e4e4" class="style12" style="width: 10%" colspan="2">
					...
					?>
						Last Update: <?php echo $row_yyww2_result['when_process']; ?>
					<?php } ?>
				</td>
			</tr>
		</table>
		...
		<table cellSpacing="1" cellPadding="1" border="0" width="200">
			...
			<?php if ($con_roblem_you_result_rows > 0) { ?>
				<tr vAlign="center">
					...
					<td bgColor="red" class="style12" style="width: 10%"><a href="contact_status_report_employee.php?ty_id=<?php echo $_COOKIE['userinitials'] ?>"><?php echo $con_roblem_you_result_rows; ?></a></td>
				</tr>
			<?php } ?>
			...
			?>
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12left" style="width: 10%">
						...
						?>
					<td bgColor="#e4e4e4" class="style12" style="width: 10%"><a href="contact_status_report_employee.php?ty_id=<?php echo $con2_roblem_all_result_array['employee']; ?>"><?php echo $con3_roblem_you_result_rows; ?></a>
				</tr>
			...
			<?php if ($con_roblem_all_result_rows > 0) { ?>
				<tr vAlign="center">
					...
					<td bgColor="#e4e4e4" class="style12" style="width: 10%"><a href="contact_status_report_employee.php?ty_id=All"><?php echo $con_roblem_all_result_rows; ?></a></td>
				</tr>
			<?php } ?>
			<tr vAlign="center">
				<td bgColor="#e4e4e4" class="style12" style="width: 10%" colspan="2">
		...
		$sql_dc = "SELECT * FROM ucbdb_credits WHERE pending = 'Denied'  AND total > 0";
		...
		<table cellSpacing="1" cellPadding="1" border="0" width="200">
			...
			<tr vAlign="center">
				<td bgColor="#e4e4e4" class="style12" style="width: 10%">
					Pending Credits</td>
				<td bgColor="#e4e4e4" class="style12" style="width: 10%">
					<a href="pending_credits.php?posting=yes&"><?php echo $count_pc; ?></a>
				</td>
			</tr>
			<tr vAlign="center">
				<td bgColor="#e4e4e4" class="style12" style="width: 10%">
					Denied Credits</td>
				<td bgColor="#e4e4e4" class="style12" style="width: 10%">
					<a href="denied_credits.php?posting=yes&"><?php echo $count_dc; ?></a>
				</td>
			</tr>
			<tr vAlign="center">
				<td bgColor="#e4e4e4" class="style12" style="width: 10%">
		...
		<table cellSpacing="1" cellPadding="1" border="0" width="200">
			...
			?>
				<tr>
					<td vAlign="center" bgColor="d9f2ff" class="style12left" style="width: 13%; height: 22px;"><strong><?php echo $ind_report['distribution_center']; ?></strong> </td>
					<td bgColor="<?php echo $ind_report['bgcolor']; ?>" class="style12" style="width: 10%; height: 22px;"><a href="eod_upload.php?warehouse_name=<?php echo $ind_report['distribution_center']; ?>&link=<?php echo $ind_report['link']; ?>"><?php echo $ind_report['message']; ?></a></td>
				</tr>
			<?php
			}
			?>
...
and ubox_order_fedex_details.orders_id in (Select orders_id from orders_sps where sent = 1)";
			...
			<table cellSpacing="1" cellPadding="1" border="0" width="250">
				...
				<tr vAlign="center">
					...
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="pending_shipments.php?tbl=losangeles&posting=yes" target="_blank"><?php echo $count_pc; ?></a>
					</td>
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="shipments_shipped.php?tbl=losangeles&posting=yes" target="_blank"><?php echo $count_pc_tot_for_day; ?></a>
					</td>
				</tr>
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">Hunt Valley</td>
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="pending_shipments.php?tbl=huntvally&posting=yes" target="_blank"><?php echo $count_pc2; ?></a>
					</td>
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="shipments_shipped.php?tbl=huntvally&posting=yes" target="_blank"><?php echo $count_pc_tot_for_day2; ?></a>
					</td>
				</tr>
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">Hannibal</td>
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="pending_shipments.php?tbl=hannibal&posting=yes" target="_blank"><?php echo $count_pc3; ?></a>
					</td>
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="shipments_shipped.php?tbl=hannibal&posting=yes" target="_blank"><?php echo $count_pc_tot_for_day3; ?></a>
					</td>
				</tr>
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">Salt Lake</td>
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="pending_shipments.php?tbl=saltlake&posting=yes" target="_blank"><?php echo $count_pc4; ?></a>
					</td>
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="shipments_shipped.php?tbl=saltlake&posting=yes" target="_blank"><?php echo $count_pc_tot_for_day4; ?></a>
					</td>
				</tr>
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">New Items</td>
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="pending_shipments.php?tbl=newitem&posting=yes" target="_blank"><?php echo $count_pc5; ?></a>
					</td>
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="shipments_shipped.php?tbl=newitem&posting=yes" target="_blank"><?php echo $count_pc_tot_for_day5; ?></a>
					</td>
				</tr>
				...
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12">
						...
						while ($result_pc_row = array_shift($result_pc)) {
							...
							if ($data_found == "no") {
						?>
								<a href="orders.php?id=<?php echo $result_pc_row["orders_id"]; ?>&proc=View&page=0" target="_blank"><?php echo $result_pc_row["orders_id"]; ?></a>
						<?php }
						} ?>
				...
				while ($myrowsel = array_shift($result)) { ?>
					<tr vAlign="center">
						<td colspan="2" bgColor="#e4e4e4" class="style12" style="height: 16px">
							Last Update: <?php echo $myrowsel["variablevalue"]; ?>
						</td>
					</tr>
				<?php
				}
			...
			<table cellSpacing="1" cellPadding="1" border="0" width="200">
				...
				<tr vAlign="center">
					<?php if ($ml_proc_result_rows != 0) { ?>
						...
						<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<?php } ?>
						<a href="http://www.usedcardboardboxes.com/moving_leads/">Moving.com Processing</a><br>User & Pass: ucbox
						</td>
				</tr>
...
FROM orders_active_export  GROUP BY tracking_number ORDER BY `total` DESC) as A WHERE A.total>1";
			...
			<table cellSpacing="1" cellPadding="1" border="0" width="200">
				...
				?>
					...
					<tr vAlign="center">
						<td bgColor="#e4e4e4" class="style12" style="width: 10%">
							<a href="dupe_view.php?number=<?php echo $value; ?>">There are <?php echo $value; ?> Duplicates!</a>
						</td>
					</tr>
			...
			<table cellSpacing="1" cellPadding="1" border="0" width="200">
				...
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%" colspan="2">Pending Returns:
						<a href="return_status_report.php"><?php echo $returnsresnum; ?></a>
					</td>
				</tr>
			</table>
		...
		<td valign="top">
			<table cellSpacing="1" cellPadding="1" border="0" width="200">
				...
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="https://loops.usedcardboardboxes.com/report_box_bucks_code.php">Box Bucks Code report</a>
					</td>
				</tr>
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
				...
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="http://www.usedcardboardboxes.com/sps/index.php?posting=yes&page=0&searchcrit=&action=12345672343223433445">SPS Shipped Order Report</a>
					</td>
				</tr>
				...
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%"> <a href="report_restricted_bbcode.php">Restricted BB Code Report</a></td>
				</tr>
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%"> <a href="https://loops.usedcardboardboxes.com/report_freight_broker.php">Freight Broker Report</a></td>
				</tr>
			</table>
			...
			<table cellSpacing="1" cellPadding="1" border="0" width="200">
				...
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="https://b2c.usedcardboardboxes.com/b2c-order-giftcard.php" target="_blank">B2C Order - Post directly</a>
					</td>
				</tr>
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
				...
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="http://loops.usedcardboardboxes.com/huntvalleywarehouse_141592653.php">Hunt Valley Dashboard</a>
					</td>
				</tr>
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
			...
			<table cellSpacing="1" cellPadding="1" border="0" width="200">
				...
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						Awaiting Approval: <a href="http://www.usedcardboardboxes.com/administration/affiliate_affiliates.php"><?php echo $a_qryresnum; ?></a></td>
				</tr>
			</table>
			<br>
			<br>
			...
			<table cellSpacing="1" cellPadding="1" border="0" width="200">
				<form action="update_masterpin.php" name="masterpin" method="post">
					...
					while ($myrowsel = array_shift($result)) { ?>
						<tr vAlign="center">
							<td bgColor="#e4e4e4" class="style12" style="width: 10%">
								Master Pin: <input type="password" name="txtmaterpin" id="txtmaterpin" value="<?php echo $myrowsel["variablevalue"]; ?>" />
							</td>
						</tr>
					<?php
					}
							...
							<select name="emailgrp" id="emailgrp" onchange="onchgemlgrp(this.value); return false;">
								...
								while ($myrowsel = array_shift($result)) {
									...
									if (isset($_REQUEST["emailgrpid"])) {
										if ($myrowsel["unqid"] == $_REQUEST["emailgrpid"]) echo " selected ";
									}
			...
			<table cellSpacing="1" cellPadding="1" border="0" width="200">
				...
				<tr vAlign="center">
					<td bgColor="#e4e4e4" class="style12" style="width: 10%">
						<a href="http://www.usedcardboardboxes.com/cookie_eater.php">Delete Cookies and Stored Values</a>
					</td>
				</tr>
