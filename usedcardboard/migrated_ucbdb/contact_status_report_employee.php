...
$ship_it_result = db_query($contact_it, db());
...
?>
	<tr vAlign="center">
		...
		<font face="Arial, Helvetica, sans-serif" color="#333333" size="1"><?php  echo $stat; ?> </font></td>	
		<td bgColor="#e4e4e4" class="style3" style="width: 6%; height: 22px;">		<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
		<a href="contact_status_drill.php?id=<?php  echo $report_data["id"]; ?>&proc=View&"><?php  echo $report_data["first_name"]; ?> <?php  echo $report_data["last_name"]; ?></a></td>
		<td bgColor="#e4e4e4" style="width: 11%; height: 22px;" class="style4">
