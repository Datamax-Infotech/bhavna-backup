...
<form name="rptSearch" action="report_move.php" method="GET">
...
$sql3 = "SELECT DISTINCT site_referrer FROM orders";
$result3 = db_query($sql3,db() );
while ($myrowsel3 = array_shift($result3)) {
?>
<option value="<?php  echo $myrowsel3["site_referrer"]; ?>"><?php  echo $myrowsel3["site_referrer"]; ?></option>
<?php  } ?>
</select>from
