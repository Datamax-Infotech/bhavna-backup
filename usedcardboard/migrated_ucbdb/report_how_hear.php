...
<body>
	...
	<div class="main_data_css">
		...
		<form name="rptSearch" action="report_how_hear.php" method="GET">
			...
			<span class="style13"><span class="style15">
					...
					<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
						...
						<select name="referrer">
							...
							$sql3 = "SELECT DISTINCT how_to_hear_about FROM orders";
							$result3 = db_query($sql3);
							while ($myrowsel3 = array_shift($result3)) {
							?>
								<option value="<?php echo $myrowsel3["how_to_hear_about"]; ?>"><?php echo $myrowsel3["how_to_hear_about"]; ?></option>
							<?php  } ?>
						</select>from
						</span>
		...
		?>
			...
			<table cellSpacing="1" cellPadding="1" width="500" border="0">
				...
				$query = "SELECT * FROM orders INNER JOIN orders_products ON orders.orders_id=orders_products.orders_id WHERE how_to_hear_about LIKE '$referrer'";
				if ($_GET["start_date"] != "") {
