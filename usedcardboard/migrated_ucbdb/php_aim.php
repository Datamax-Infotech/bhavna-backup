...
<html>
<head>
<title>Authorize.Net Credit Example for David Krasnow</title>
...
PHP Example Code for UCB Credit Transactiosn</b><br>
<br>
David - This is just a test to:<br>
...
echo "<b>1. Post the transaction (see the code for specific information):</b><br>";
...
echo "<b>2: Get post results:</b><br>";
echo $resp;
echo "<br>";
...
echo "3: Parse post results (simple approach)<br>";
...
echo "<b>4: Parse the results string into individual, meaningful segments:</b><br>";
