...
function send_email(string $from_email, string $to_email, string $subject, string $eml_body): void 
{
...
echo "window.location.href=\"orders.php?id=" . encrypt_url($_REQUEST["order_id"]) . '&proc=View&searchcrit=&page=0' . "\";";
echo "</script>";
echo "<noscript>";
echo "<meta http-equiv=\"refresh\" content=\"0;url=orders.php?id=" . encrypt_url($_REQUEST["order_id"]) . '&proc=View&searchcrit=&page=0' . "\" />";
echo "</noscript>";
exit;
