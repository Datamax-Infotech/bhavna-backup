<?php 
	...
	function update_shopify_tracking_no_remove_old($orders_id, $shopify_order_no, $tracking_number_org, $fulfillments_no, $carrier_code_org, $tracking_urls){
	...
	function update_shopify_tracking_no_org($orders_id, $shopify_order_no, $tracking_number_org, $carrier_code_org, $tracking_urls){
		//update the Shopify Tracking number
		if ($shopify_order_no != "")
		{			
			$shopify_fulfillment_id = "";
