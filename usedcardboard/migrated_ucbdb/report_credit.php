	...
	<div class="main_data_css">
		...
		<form name="rptSearch" action="report_credit.php" method="GET">
			<?php 	
				...
				$chargeback = isset($_GET["chargeback"]) ? $_GET["chargeback"] : "A";
			?>
					...
					<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
						...
						<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">with&nbsp;
							...
							<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">that were
								<?php $pending = isset($_REQUEST['pending']) ? $_REQUEST['pending']: ""; ?>
								<select name="pending">
				...
				?>
					<tr vAlign="center">
						<td bgColor="#e4e4e4" class="style3" style="width: 7%; height: 22px;">
							<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
								<?php echo date('m-d-Y', strtotime($row["credit_date"])); ?>
							</font>
						</td>
						<td bgColor="#e4e4e4" class="style3" style="width: 7%; height: 22px;">
							<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
								<a href="orders.php?id=<?php echo encrypt_url($row["orders_id"]); ?>&proc=View&"><?php echo $row["orders_id"]; ?></a>
							</font>
						</td>
						...
						<td bgColor="#e4e4e4" class="style8" style="width: 50%; height: 22px;">
							<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
								<?php echo $row["notes"]; ?>
							</font>
						</td>
						<td bgColor="#e4e4e4" style="width: 28%; height: 22px;" class="style11">
							<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
