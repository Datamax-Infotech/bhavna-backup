							...
							<td>
								<form name="rptSearch" action="report_sop.php" method="GET">
									...
									<select name="division">
										...
										?>
											<option value="<?php echo $myrowsel2["id"]; ?>" 
											<?php
			...
			<table cellSpacing="1" cellPadding="1" width="1000" border="0">
				...
				?>
					<tr vAlign="center">
						...
						<td bgColor="#e4e4e4" class="style3">
							<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
								<a href="report_sop.php?action=run&employee=<?php echo $_REQUEST["employee"]; ?>&division=<?php echo $_REQUEST["division"]; ?>&department=<?php echo $_REQUEST["department"]; ?>&frequency=<?php echo $_REQUEST["frequency"]; ?>&search=<?php echo $_REQUEST["search"]; ?>&id=<?php echo $row["H"]; ?>">Details</a>
							</font>
						</td>
						<td bgColor="#e4e4e4" class="style3">
							<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
								<a href="report_sop_edit.php?employee=<?php echo $row["G1"]; ?>&division=<?php echo $row["G2"]; ?>&department=<?php echo $row["G3"]; ?>&frequency=<?php echo $row["G4"]; ?>&backemployee=<?php echo $_REQUEST["employee"]; ?>&backdivision=<?php echo $_REQUEST["division"]; ?>&backdepartment=<?php echo $_REQUEST["department"]; ?>&backfrequency=<?php echo $_REQUEST["frequency"]; ?>&backsearch=<?php echo $_REQUEST["search"]; ?>&id=<?php echo $row["H"]; ?>">Edit</a>
							</font>
						</td>
					</tr>
					<?php
					...
					?>
						<tr>
							<td colspan="8" bgColor="#e4e4e4" class="style3">
								<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
									<?php echo $row["I"]; ?>
								</font>
							</td>
