		...
		<div class="header">
			...
			<div class="login-user">
				...
				<div class="logout_div_po">
					<a href="#" id="logout_link" onclick="show_logout_option(this)"><span class="login-username"><?php echo $emp_name; ?></span><img src="images/employees/new_header_noimg.jpg" width="25px" height="25px"></a>
				</div>
