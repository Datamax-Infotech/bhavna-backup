<?php
function searchbox_new(string $url, string|int $eid):void
{
?>
	<style>
	...
	<form method="get" action="<?php echo $url ?>">
		...
		<div class="search_main_div">
			<div class="search">
				...
				<input name="searchcrit" type=text class="ser_form_component" id="searchcrit" placeholder="Enter Order ID" value="<?php if (isset($_REQUEST["searchcrit"])) {																														} ?>" size=50>
