...
<table cellSpacing="1" cellPadding="1" width="500" border="0">
	...
	<tr>
		...
		<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
		TOTAL CLICKS</font></td>
		<td style="width: 10%" class="style17">
		<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
		TOTAL ORDERS</font></td>
...
$result_mainref = db_query($sql_mainref,db() );
...
while ($myrowsel_mainref = array_shift($result_mainref)) {
	...
	$total_revenue = 0;
	$total_orders = 0;
	$res_totorder = db_query($query,db());
	...
	?>
		<tr vAlign="center">
			<td bgColor="#e4e4e4" class="style3" style="width: 20%; height: 22px;"><font face="Arial, Helvetica, sans-serif" color="#333333" size="1">	
			<?php  echo $myrowsel_mainref["site_referrer"]; ?></font></td>
			<td bgColor="#e4e4e4" class="style3" style="width: 10%; height: 22px;"><font face="Arial, Helvetica, sans-serif" color="#333333" size="1">	
			<?php  echo $total_clicks; ?></font></td>
			<td bgColor="#e4e4e4" style="width: 10%; height: 22px;" class="style3"><font face="Arial, Helvetica, sans-serif" color="#333333" size="1">	
			<?php  echo $total_orders; ?></font></td>
			<td bgColor="#e4e4e4" style="width: 10%; height: 22px;" class="style3"><font face="Arial, Helvetica, sans-serif" color="#333333" size="1">	
			<?php  echo '$'. number_format($total_revenue,2); ?></font></td>
		</tr>
