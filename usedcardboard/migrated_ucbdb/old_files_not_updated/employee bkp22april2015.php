...
----------------------------------------------------------------*/
	...
	if ($reccount == 0) 
		{
		//$resultcount = (mysql_query($sqlcount,db() )) OR DIE (ThrowError($err_type,$err_descr););
		$resultcount = (mysql_query($sqlcount,db() )) OR DIE (ThrowError("9991SQLresultcount",$sqlcount));				
...
if ($page > 1) { 
 	//$newpage = $page - 2;
	$newpage = $page - 1;	
   // echo $newpage."**";	//previous page is page - 1
 	//}
 	//if ($newpage != -1) {
	?>
	<br>
...
----------------------------------------------------------------*/
	...
	?>
	   ...
	   <TR>
         ...
         <TD><DIV CLASS='TBL_COL_HDR'><a href='employee.php?posting=yes&sorting=yes&sort=username&sort_order_pre=<?php  echo $sort_order_pre;?>&page=<?php  echo $page; ?>&toggle_status=<?php  echo $_REQUEST['toggle_status'];?>' >User ID</a></DIV></TD> 
<!--echo "	<TD><DIV CLASS='TBL_COL_HDR'>PASSWORD</DIV></TD>"; -->
	<TD><DIV CLASS='TBL_COL_HDR'><a href='employee.php?posting=yes&sorting=yes&sort=name&sort_order_pre=<?php  echo $sort_order_pre;?>&page=<?php  echo $page; ?>&toggle_status=<?php  echo $_REQUEST['toggle_status'];?>' >Employee Name</a></DIV></TD>
	<TD><DIV CLASS='TBL_COL_HDR'><a href='employee.php?posting=yes&sorting=yes&sort=initials&sort_order_pre=<?php  echo $sort_order_pre;?>&page=<?php  echo $page; ?>&toggle_status=<?php  echo $_REQUEST['toggle_status'];?>' >Initials</a></DIV></TD>
	<TD><DIV CLASS='TBL_COL_HDR'><a href='employee.php?posting=yes&sorting=yes&sort=email&sort_order_pre=<?php  echo $sort_order_pre;?>&page=<?php  echo $page; ?>&toggle_status=<?php  echo $_REQUEST['toggle_status'];?>' >Email Address</a></DIV></TD>
	<TD><DIV CLASS='TBL_COL_HDR'><a href='employee.php?posting=yes&sorting=yes&sort=level&sort_order_pre=<?php  echo $sort_order_pre;?>&page=<?php  echo $page; ?>&toggle_status=<?php  echo $_REQUEST['toggle_status'];?>' >Level</a></DIV></TD>
...
----------------------------------------------------------------------*/
if ($proc == "New") {
echo "<a href=\"employee.php?posting=yes\">Back</a><br><br>";
?>
...
option_two,
option_three
 $addl_insert_crit ) VALUES ( '$username',
'$password',
'$name',
'$initials',
'$email',
...
if ($sql_debug_mode==1) { echo "<BR>SQL: $sql<BR>"; }
$result = mysql_query($sql,db() ) or die ("Error Retrieving Records (9993SQLGET)");
