...
----------------------------------------------------------------*/
	...
	echo "	<tr align='middle'><td colspan='7' class='style24' style='height: 16px'><strong>EMPLOYEE SETUP</strong></td></tr>";
	echo "	<TR>";

echo "		<TD><DIV CLASS='TBL_COL_HDR'>User ID</DIV></TD>"; 
// echo "		<TD><DIV CLASS='TBL_COL_HDR'>PASSWORD</DIV></TD>"; 
echo "		<TD><DIV CLASS='TBL_COL_HDR'>Employee Name</DIV></TD>"; 
echo "		<TD><DIV CLASS='TBL_COL_HDR'>Initials</DIV></TD>"; 
echo "		<TD><DIV CLASS='TBL_COL_HDR'>Email Address</DIV></TD>"; 
echo "		<TD><DIV CLASS='TBL_COL_HDR'>Level</DIV></TD>"; 
echo "		<TD><DIV CLASS='TBL_COL_HDR'>Status</DIV></TD>"; 
