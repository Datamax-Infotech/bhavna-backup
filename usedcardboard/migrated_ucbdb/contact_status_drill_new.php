...
<body>
	...
	$thispage	= "contact_status_drill_new.php"; //SET THIS TO THE NAME OF THIS FILE
					...
					<tr>
						<td valign="top">
							<table cellSpacing="1" cellPadding="1" border="0" style="width: 300px">
								...
								<?php if ($help != '') { ?>
									<tr bgColor="#e4e4e4">
										<td height="13" style="width: 100px" class="style1"><?php if ($voicemail == 'https://webrouter') {
																								echo 'Voicemail';
																							} else {
																								echo 'Help';
																							} ?></td>
				...
				?>
					...
					<form action="addeod_contact.php" method="post" encType="multipart/form-data" name="rptSearch">
						...
						<table cellSpacing="1" cellPadding="1" width="500" border="0">
							...
							<tr>
								<td bgColor="#c0cdda" style="width: 7%; height: 16px;">
									<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
										Warehouse
								</td>
								<td bgColor="#c0cdda" style="width: 25%; height: 16px;">
									<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
										Date
								</td>
								<td bgColor="#c0cdda" style="width: 24%; height: 16px;">
									<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
							...
							<tr vAlign="center">
								...
								<td bgColor="#e4e4e4" style="width: 7%" class="style10">
									<font face="Arial, Helvetica, sans-serif" color="#333333" size="1"><input type="text" name="search_date" size="11" value="<?php echo date('m/d/y'); ?>"> <a href="#" onclick="cal1xx.select(document.rptSearch.search_date,'anchor1xx','MM/dd/yy'); return false;" name="anchor1xx" id="anchor1xx"><img border="0" src="images/calendar.jpg"></a>
								</td>
					...
					<br />
					<br />
					<IFRAME SRC="show_fax.php?id=<?php echo $id; ?>&file=<?php echo $help; ?>" WIDTH=1121 HEIGHT=1000>
