...
<table cellSpacing="1" cellPadding="1" width="98%" border="0">
	...
	<tr>
		...
		<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">		
		Starting Quantity <?php  /* echo date( 'm/d/Y',strtotime($start_date)); */ ?></td>
		<td class="style5" style="width: 9%">
		<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">		
		Adjustments</td>		
		<td class="style5" style="width: 9%">
...
<!--		<?php  /* echo $row["item_name"]; */ ?></td> -->
		...
		<td align="middle" bgColor="#e4e4e4" style="width: 5%; height: 22px;" class="style3"><font face="Arial, Helvetica, sans-serif" color="#333333" size="1"><?php 
