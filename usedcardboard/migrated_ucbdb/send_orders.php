...
<body>
	<?php
	function convert_state_abbrv(string $state_abbr_org): string
	{
		$state_abbr = $state_abbr_org;
		if ($state_abbr_org == "AL") {
			$state_abbr = "Alabama";
		}
		if ($state_abbr_org == "AK") {
			$state_abbr = "Alaska";
		}
		if ($state_abbr_org == "AZ") {
			$state_abbr = "Arizona";
		}
		if ($state_abbr_org == "AR") {
			$state_abbr = "Arkansas";
		}
		if ($state_abbr_org == "CA") {
			$state_abbr = "California";
		}
		if ($state_abbr_org == "CO") {
			$state_abbr = "Colorado";
		}
		if ($state_abbr_org == "CT") {
			$state_abbr = "Connecticut";
		}
		if ($state_abbr_org == "DE") {
			$state_abbr = "Delaware";
		}
		if ($state_abbr_org == "DC") {
			$state_abbr = "District of Columbia";
		}
		if ($state_abbr_org == "FL") {
			$state_abbr = "Florida";
		}
		if ($state_abbr_org == "GA") {
			$state_abbr = "Georgia";
		}
		if ($state_abbr_org == "HI") {
			$state_abbr = "Hawaii";
		}
		if ($state_abbr_org == "ID") {
			$state_abbr = "Idaho";
		}
		if ($state_abbr_org == "IL") {
			$state_abbr = "Illinois";
		}
		if ($state_abbr_org == "IN") {
			$state_abbr = "Indiana";
		}
		if ($state_abbr_org == "IA") {
			$state_abbr = "Iowa";
		}
		if ($state_abbr_org == "KS") {
			$state_abbr = "Kansas";
		}
		if ($state_abbr_org == "KY") {
			$state_abbr = "Kentucky";
		}
		if ($state_abbr_org == "LA") {
			$state_abbr = "Louisiana";
		}
		if ($state_abbr_org == "ME") {
			$state_abbr = "Maine";
		}
		if ($state_abbr_org == "MD") {
			$state_abbr = "Maryland";
		}
		if ($state_abbr_org == "MA") {
			$state_abbr = "Massachusetts";
		}
		if ($state_abbr_org == "MI") {
			$state_abbr = "Michigan";
		}
		if ($state_abbr_org == "MN") {
			$state_abbr = "Minnesota";
		}
		if ($state_abbr_org == "MS") {
			$state_abbr = "Mississippi";
		}
		if ($state_abbr_org == "MO") {
			$state_abbr = "Missouri";
		}
		if ($state_abbr_org == "MT") {
			$state_abbr = "Montana";
		}
		if ($state_abbr_org == "NE") {
			$state_abbr = "Nebraska";
		}
		if ($state_abbr_org == "NV") {
			$state_abbr = "Nevada";
		}
		if ($state_abbr_org == "NH") {
			$state_abbr = "New Hampshire";
		}
		if ($state_abbr_org == "NJ") {
			$state_abbr = "New Jersey";
		}
		if ($state_abbr_org == "NM") {
			$state_abbr = "New Mexico";
		}
		if ($state_abbr_org == "NY") {
			$state_abbr = "New York";
		}
		if ($state_abbr_org == "NC") {
			$state_abbr = "North Carolina";
		}
		if ($state_abbr_org == "ND") {
			$state_abbr = "North Dakota";
		}
		if ($state_abbr_org == "OH") {
			$state_abbr = "Ohio";
		}
		if ($state_abbr_org == "OK") {
			$state_abbr = "Oklahoma";
		}
		if ($state_abbr_org == "OR") {
			$state_abbr = "Oregon";
		}
		if ($state_abbr_org == "PA") {
			$state_abbr = "Pennsylvania";
		}
		if ($state_abbr_org == "RI") {
			$state_abbr = "Rhode Island";
		}
		if ($state_abbr_org == "SC") {
			$state_abbr = "South Carolina";
		}
		if ($state_abbr_org == "SD") {
			$state_abbr = "South Dakota";
		}
		if ($state_abbr_org == "TN") {
			$state_abbr = "Tennessee";
		}
		if ($state_abbr_org == "TX") {
			$state_abbr = "Texas";
		}
		if ($state_abbr_org == "UT") {
			$state_abbr = "Utah";
		}
		if ($state_abbr_org == "VT") {
			$state_abbr = "Vermont";
		}
		if ($state_abbr_org == "VA") {
			$state_abbr = "Virginia";
		}
		if ($state_abbr_org == "WA") {
			$state_abbr = "Washington";
		}
		if ($state_abbr_org == "WV") {
			$state_abbr = "West Virginia";
		}
		if ($state_abbr_org == "WI") {
			$state_abbr = "Wisconsin";
		}
		if ($state_abbr_org == "WY") {
			$state_abbr = "Wyoming";
		}
	...
	while ($orders_products = array_shift($orders_products_query)) {
		...
		$ProdItemArray[] = array(
			'product_id' => $orders_products['ubox_id'], 'product_sku' => $orders_products['ubox_sku'], 'product_name' => $orders_products['ubox_name'], 'product_weight' => $orders_products['ubox_weight'],
