...
<body>
	...
	<table cellSpacing="1" cellPadding="1" width="98%" border="0">
		...
		while ($report_data = array_shift($find_it_result)) {
			...
			$find_it_result_child = db_query($find_it_child);
		...
		?>
			<tr vAlign="center">
				<td bgColor="#e4e4e4" class="style3" style="width: 6%; height: 22px;">
					<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
						<a href="orders.php?id=<?php echo encrypt_url($report_data["orders_id"]); ?>&proc=View&searchcrit=&page=0"><?php echo $report_data["orders_id"]; ?></a>
				</td>
				...
				<td bgColor="#e4e4e4" style="width: 11%; height: 22px;" class="style4" align="center">
					...
					?>
					<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
						<div align="center"><?php echo number_format($difference, 0) ?></div>
					</font>
				</td>
				<td bgColor="#e4e4e4" style="width: 11%; height: 22px;" class="style4">
					<font face="Arial, Helvetica, sans-serif" color="#333333" size="1">
						<div align="center"><?php echo $report_data["customers_name"]; ?></div>
					</font>
				</td>
				...
				<td align="middle" bgColor="#e4e4e4" style="width: 11%; height: 22px;" class="style3">
					<font face="Arial, Helvetica, sans-serif" color="#333333" size="1"><?php echo $report_data["customers_telephone"]; ?></font>
				</td>
			</tr>
		<?php  } ?>
	</table>
