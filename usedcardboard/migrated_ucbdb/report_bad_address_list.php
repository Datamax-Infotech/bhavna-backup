		...
		<form method="post" name="shippingtool" action="report_bad_address_list.php">
			<table border="0">
				<tr>
					...
					<td>
						&nbsp;
						<!-- Show only Order Issue Records<input type="checkbox" name="chkshow_order_issue" id="chkshow_order_issue" value="yes" <?php if ($_REQUEST["chkshow_order_issue"] == "yes") {
																																						echo " checked ";
																																					} ?> /> -->
			...
			<table width="1200px" border="0" cellspacing="1" cellpadding="1">
				...
				<tr>
					...
					<td width="20px" bgcolor="#D9F2FF" align="center">
						<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Order Amount&nbsp;
							<a href="<?php echo $sorturl; ?>&po_amount=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&po_amount=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
						</font>
					</td>

					<td width="20px" bgcolor="#D9F2FF" align="center">
						<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Bad Address&nbsp;
							<a href="<?php echo $sorturl; ?>&bad_add=asc&sort=y"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&bad_add=desc&sort=y"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
						</font>
					</td>
				...
				?>
						<tr valign="middle">
							...
							<td width="200px" bgcolor="<?php echo $rowcolor ?>" align="left">
								<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $order_add ?></font>
							</td>

							<td width="100px" bgcolor="<?php echo $rowcolor ?>" align="center">
								<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $data["fedex_search_resp_state"]; ?></font>
							</td>

							<td width="100px" bgcolor="<?php echo $rowcolor ?>" align="center">
								<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $data["fedex_search_resp_classification"]; ?></font>
							</td>
					...
					<?php
						...
						$MGArray_data[] = array(
							'fedex_search_resp_state' => $data["fedex_search_resp_state"], 'order_add' => $order_add,
				...
				if (isset($_REQUEST["sort"])) {
					...
					//variables added by bhavna as it was showing undefined 
					$vc_array_compid = array();
					$vc_array_nickname = array();
					$vc_array_po_poorderamount = array();
					$vc_array_order_add = array();
					$vc_array_fedex_search_resp_state = array();
					$vc_array_fedex_search_resp_classification = array();
					...
					?>
						<tr valign="middle">
							<td width="50px" bgcolor="<?php echo $rowcolor ?>"><a target="_blank" href="orders.php?id=<?php echo $MGArraytmp2["orders_id"] ?>&proc=View&searchcrit=<?php echo $MGArraytmp2["orders_id"] ?>&page=0">
							...
							<td width="200px" bgcolor="<?php echo $rowcolor ?>" align="left">
								<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["order_add"] ?></font>
							</td>

							<td width="20px" bgcolor="<?php echo $rowcolor ?>" align="center">
								<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["fedex_search_resp_state"]; ?></font>
							</td>

							<td width="100px" bgcolor="<?php echo $rowcolor ?>" align="center">
								<font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["fedex_search_resp_classification"]; ?></font>
							</td>
