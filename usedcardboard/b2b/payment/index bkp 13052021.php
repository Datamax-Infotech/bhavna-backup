		...
		<div class="new_container no-top-padding">
			...
			<nav aria-label="Breadcrumb">
				...
				<li class="breadcrumb__item breadcrumb__item--completed">
				  <a class="breadcrumb__link" href="../index.php?id=<? echo $ProductLoopId;?>">Select Quantity</a>
				...
				<li class="breadcrumb__item breadcrumb__item--completed">
					<a class="breadcrumb__link" href="../contact.php?id=<? echo $ProductLoopId;?>">Contact</a>
				...
				<li class="breadcrumb__item breadcrumb__item--completed">
					<a class="breadcrumb__link" href="../shipping.php?id=<? echo $ProductLoopId;?>">Shipping</a>
					<svg class="icon-svg icon-svg--color-adaptive-light icon-svg--size-10 breadcrumb__chevron-icon" aria-hidden="true" focusable="false"> <use xlink:href="#chevron-right"></use> </svg>
				</li>
				...
				<div class="sidebar-sept"></div>
					...
					<table class="sidebar-table" id="paymenttbl">
						...
						<tr id="ccfee_tr">
							...
							<td align="right">$<? echo $cc_fees ; ?></td>
							<td align="right">$<? echo $cc_fees ; ?></td>
						</tr>
