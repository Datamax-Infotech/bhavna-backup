								...
								<div class="fieldset">
									<div data-address-field="password" data-autocomplete-field-container="true" class="field field--optional">
										<div class="field__input-wrapper"><label class="field__label field__label--visible" for="checkout_paswd">First name</label>
										  <input placeholder="Password" autocomplete="" autocorrect="off" data-backup="paswd" class="field__input" aria-required="true" size="30" type="password" name="txtCntInfoFNm1" id="checkout_paswd" value="">
										</div>
									</div>
									<div data-address-field="conf_password" data-autocomplete-field-container="true" class="field field--optional">
										<div class="field__input-wrapper"><label class="field__label field__label--visible" for="checkout_conf_pass">Last name</label>
										  <input placeholder="Confirm Password" autocomplete="" autocorrect="off" data-backup="last_name" class="field__input" aria-required="true" size="30" type="password" name="txtCntInfoLNm1" id="checkout_conf_pass" value="">
										</div>
									</div>
								</div>
							</div>
				...
				<div class="inner-content" id="order-content">
					...
					<table class="sidebar-table">
						...
						<tr>
							...
							<td align="right">USD&nbsp;&nbsp;<span class="payment-due__price"><? echo trim($orderData['productTotal']); ?></span></td>
						</tr>
					</table>
