...
$shippinginfo = ""; $billinginfo = ""; $payment_method = "";
if ($sessionId){
...
<?
	...
	$eml_confirmation2 ="<html style=\"width:100%%;font-family: 'Montserrat', 'Helvetica Neue', Helvetica, Arial, 'sans-serif';-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0;\"><head><link rel='preconnect' href='https://fonts.gstatic.com'>
		...
		//$emlstatus = sendemail_attachment(null, "", "prasad@extractinfo.com", "", "", "Operations@UsedCardboardBoxes.com", "UCB Operations Team", "Operations@UsedCardboardBoxes.com", "New B2B Online Order ID #" . $order_id, $eml_confirmation2);
	/*	
				...
				<div class="sidebar-sept"></div>
					...
					<table class="sidebar-table">
						...
						<tr>
							...
							<td align="center"><? echo $orderData['hdLeadTime'] ; ?></td>
