...
error_reporting(0);
	...
	$sql1 = "SELECT * FROM water_cron_fordash_new WHERE warehouse_id = ? and data_year = ?";
...
//For Summary of Waste Processing(YTD)
		$res1 = db_query("Select * from water_cron_summary_rep_new where warehouse_id = " . $warehouse_id_cronjobs . " and data_year = $selected_yr");
