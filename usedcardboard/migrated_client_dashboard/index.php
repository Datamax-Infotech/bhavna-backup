...
<body>
		...
		if ($_REQUEST["hd_forgotpwd_upd"] == "yes") {
			...
			if ($rec_found == "no") { ?>
				<table width="350" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
					<tr>
						<td>
							<form name="form1" method="post" action="client_checklogin_new.php">
								<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
									...
									<tr>
										<td colspan="2"><span class="TBL_COL_HDR_NOSHADE">
												<font color=red>Entered email address not found in our database. Please check. </font><br /></td>
									</tr>
								</table>
							</form>
						</td>
						...
						<td>
							<form name="form1" method="post" action="client_checklogin_new.php">
								<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
									...
									<tr>
										<td colspan="2"><span class="TBL_COL_HDR_NOSHADE">Please enter the email address. <br /><br />
												<font color=red>We will check the email address in our database and if found then we will send the login details in the email address.</font>
											</span></td>
									</tr>
									<tr>
	...
	<table width="300" border="0" align="center" cellpadding="0" cellspacing="1" style="BORDER-RIGHT: gray 1px solid;BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid;BORDER-BOTTOM: gray 1px solid;">
				...
				<form name="form1" method="post" action="client_checklogin_new.php">
					<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
						...
						if ($_REQUEST["action"] == "no" && isset($_REQUEST["user_block"])) {
							...
							echo "<tr><td width=\"50\">&nbsp;</td><td align=\"center\" colspan=\"3\"><br><br><span class=\"TBL_COL_HDR_NOSHADE\"><font color=red>INCORRECT EMAIL ADDRESS OR PASSWORD</font></span><br><br></td><td width=\"60\">&nbsp;</td></tr>";
						}
						?>
	...
	?>
	<table width="300" border="0" align="center" cellpadding="0" cellspacing="1" style="BORDER-RIGHT: gray 1px solid;BORDER-LEFT: gray 1px solid;BORDER-BOTTOM: gray 1px solid; height:20px;">
		<tr>
			<td>
	...
	<table width="300" border="0" align="center" cellpadding="0" cellspacing="1" style="BORDER-RIGHT: gray 1px solid;BORDER-LEFT: gray 1px solid;BORDER-BOTTOM: gray 1px solid;">
		<tr>
			<td>
				<form name="form1" method="post" action="index.php">
					<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
