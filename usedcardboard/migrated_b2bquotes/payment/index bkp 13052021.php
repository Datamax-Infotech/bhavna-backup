				...
				<div class="sidebar-sept"></div>
					...
					<table class="sidebar-table" id="paymenttbl">
						...
						<tr>
							...
							<td id="totolProQnt" align="center"><?php echo number_format(str_replace(",", "" , $orderData['productQnt']),0) ; ?></td>
							<td align="right">$<?php echo number_format(str_replace(",", "" ,$orderData['productUnitPr']),2) ; ?></td>
							<td align="right">$<?php echo number_format(str_replace("$", "" ,str_replace(",", "" ,trim($orderData['productTotal']))),2);?></td>
						</tr>
						...
						<tr>
							...
							<td align="right" >USD&nbsp;&nbsp;<span id="totalcnt" class="payment-due__price"><?php 
								$totalTemp =  str_replace("$", "", $total);
								$cc_feesTemp =  str_replace("$", "", $cc_fees);
								$total = $totalTemp + $cc_feesTemp;
